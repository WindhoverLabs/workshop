...
###sudo apt-get install -y libprotobuf-dev libprotoc-dev protobuf-compiler libeigen3-dev gazebo7 libgazebo7 libgazebo7-dev
# To use the camera plugin 
###sudo apt-get install -y libopencv-dev gstreamer1.0-* libgstreamer1.0-*
# To use the Gazebo geotagging plugin
